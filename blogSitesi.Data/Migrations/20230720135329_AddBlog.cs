    ...
    public partial class AddBlog : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("69d76eaf-7236-4d04-9a7c-2f93e8e845ca"), new Guid("92b75f4a-fb11-4122-a8f6-d405cbd76045"), "Visual Studio ASP.NET Core MVC is a powerful framework for building web applications, but it is also important to ensure that your application is secure. Security is a critical aspect of any web application, and there are several best practices that you can follow to make sure that your ASP.NET Core MVC application is secure. In this article, we will explore some of the best practices for securing your ASP.NET Core MVC application.", "Admin Test2", new DateTime(2023, 7, 20, 16, 53, 29, 402, DateTimeKind.Local).AddTicks(7686), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("2c2bd7a1-dea5-45a9-86f3-4204f9c0cc2c"), false, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Visual Studio Essay Article 1", 15 },
                    { new Guid("fada4326-915d-4ea3-af8d-d6706d8fc9a1"), new Guid("540c738f-2d82-4866-84c0-e497700bfc74"), "ASP.NET Core MVC is a powerful framework for building web applications, but it is also important to ensure that your application is secure. Security is a critical aspect of any web application, and there are several best practices that you can follow to make sure that your ASP.NET Core MVC application is secure. In this article, we will explore some of the best practices for securing your ASP.NET Core MVC application.", "Admin Test", new DateTime(2023, 7, 20, 16, 53, 29, 402, DateTimeKind.Local).AddTicks(7669), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("d9678411-71f1-41d5-8238-b9531b1083b1"), false, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "ASP.Net Core EF Article Essay", 15 }
                });
            ...
            migrationBuilder.UpdateData(
                ...
                column: "CreatedDate",
                value: new DateTime(2023, 7, 20, 16, 53, 29, 402, DateTimeKind.Local).AddTicks(8410));
            ...
            migrationBuilder.UpdateData(
                ...
                column: "CreatedDate",
                value: new DateTime(2023, 7, 20, 16, 53, 29, 402, DateTimeKind.Local).AddTicks(8417));
            ...
            migrationBuilder.UpdateData(
                ...
                column: "CreatedDate",
                value: new DateTime(2023, 7, 20, 16, 53, 29, 402, DateTimeKind.Local).AddTicks(8835));
            ...
            migrationBuilder.UpdateData(
                ...
                column: "CreatedDate",
                value: new DateTime(2023, 7, 20, 16, 53, 29, 402, DateTimeKind.Local).AddTicks(8799));
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Articles",
                keyColumn: "Id",
                keyValue: new Guid("69d76eaf-7236-4d04-9a7c-2f93e8e845ca"));

            migrationBuilder.DeleteData(
                table: "Articles",
                keyColumn: "Id",
                keyValue: new Guid("fada4326-915d-4ea3-af8d-d6706d8fc9a1"));
